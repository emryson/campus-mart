      ...
      <div className="max-w-7xl mx-auto relative z-10">
        <div className="flex flex-col lg:flex-row items-start lg:items-center justify-between gap-8">
          ...
          <div className="max-w-2xl space-y-4">
            <div className="inline-flex max-w-full items-center gap-2 px-3 py-1 rounded-full bg-emerald-500/15 border border-emerald-500/30 text-emerald-300 text-[11px] sm:text-xs font-semibold">
              <Sparkles className="w-3.5 h-3.5 text-amber-400" />
              <span className="truncate">Campus Peer-to-Peer Marketplace</span>
              {currentUni && (
            ...
            <p className="text-slate-300 text-sm sm:text-base leading-relaxed max-w-xl">
              ...
              Enjoy zero shipping delays and safe meetups right at your hall or hostel.
            </p>
            ...
            <div className="flex flex-col sm:flex-row items-stretch sm:items-center gap-3 pt-2">
              ...
              <button
                ...
                className="flex items-center justify-center gap-2 px-4 py-3 min-h-12 bg-slate-800/80 hover:bg-slate-800 text-slate-200 hover:text-white border border-slate-700 font-semibold text-sm rounded-xl transition-colors"
              >
          ...
          <div className="grid grid-cols-1 min-[380px]:grid-cols-2 gap-3 w-full lg:w-auto lg:min-w-[300px]">
